...
describe('paginate', () => {
    ...
    it('should return result based on search term on one-to-one relation', async () => {
        ...
        const catHomesClone = (0, lodash_1.clone)([catHomes[0], catHomes[1]]);
    ...
    it('should return result based on not null query on relation', async () => {
        const config = {
            sortableColumns: ['id'],
            filterableColumns: {
                'home.name': [filter_1.FilterSuffix.NOT, filter_1.FilterOperator.NULL],
            },
            relations: ['home'],
        };
        const query = {
    ...
    it('should return result based on filters chained together with and operators and or operators', async () => {
        ...
        const result = await (0, paginate_1.paginate)(query, catRepo, config);
        const expected = cats.filter((cat) => (cat.name === 'Milo' || cat.name === 'Garfield' || !cat.age) &&
